...
2. Create a container image for the node.js Web app
    ...
    > Pay attention to the results of the `build` command. You are pulling an image from the internet and adding differencing layers to it. This is part of the beauty of containers and helps make the CI/CD story so strong.
...
3. Test web app
    ...
    You can browse your running app with: http://localhost:8080 
...
4. Create a Resource Group. You will use this for the remainder of the lab.
...
4. In a terminal window, set each value to a variable as shown below
